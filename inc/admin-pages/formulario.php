...
<button class="button-primary" >
    <a style="color:#fff" href="<?php bloginfo('url'); echo '?cfact_send_user_client&url_redirect='; bloginfo('url'); echo '/wp-admin/admin.php?page=course_factory_integration_feedback'; ?>"> <?php echo esc_html( __( 'Yes', 'course_factory_integration' ) ) ?> </a>
</button>
</div>
